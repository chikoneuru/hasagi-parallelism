"""Minimum Satisfactory Share (ElasticFlow §4.1) and HASAGI's Energy-Budgeted MSS.
...
HASAGI extends MSS along the **energy axis**:
...
def greedy_marginal_energy_allocation(
    ...
    HASAGI's energy-aware analog of ``greedy_marginal_allocation``: instead of picking
