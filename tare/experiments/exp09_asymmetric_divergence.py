...
from tare.admission.mss import ScalingCurve, greedy_marginal_energy_allocation
...
def run(jobs: list[JobSpec], available_gpus: int, console: Console) -> bool:
    ...
    tare_alloc = greedy_marginal_energy_allocation(
    ...
    for name, alloc in [
        ...
        ("HASAGI EB (marginal-energy)", tare_alloc),
    ]:
