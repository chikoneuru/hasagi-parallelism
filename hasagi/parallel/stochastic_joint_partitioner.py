...
Typical frontier size is small (< 20 entries) for HASAGI-typical
...
from hasagi.parallel.joint_partitioner import JointPlan, _build_throttle_set
...
def _insert_pareto(frontier: list[_ParetoEntry], new: _ParetoEntry) -> None:
    ...
    distinct Pareto-optimal extensions which is typically small for HASAGI-
