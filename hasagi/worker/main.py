...
The actual training loop lives in ``hasagi.worker.trainer``. This module is the long-running
...
WORKER_GPU_UTIL = Gauge("hasagi_worker_gpu_util", "Approx GPU util (0..1)", ["worker_id"])
WORKER_HB = Gauge("hasagi_worker_last_heartbeat_unix", "Unix time of last heartbeat", ["worker_id"])

logger = logging.getLogger("hasagi.worker")
